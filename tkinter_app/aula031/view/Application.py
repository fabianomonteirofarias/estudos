...
class Application(Funcs, Relatorios, Validadores):
    ...
    def widgets_frame1(self):
        ...
        self.en_codigo.place(relwidth=0.1, relheight=0.08,
                             relx=0.02, rely=0.15)
        # entry nome
        self.en_nome = EntryPlaceHold(self.aba1, placeholder="Digite o nome do cliente...")
        self.en_nome.place(relwidth=0.9, relheight=0.1,
                           relx=0.02, rely=0.4)

        # entry telefone
        self.en_telefone = EntryPlaceHold(self.aba1, placeholder="Digite o número do cliente...")
        self.en_telefone.place(relwidth=0.4, relheight=0.1,
                               relx=0.02, rely=0.7)
        # entry cidade
        self.en_cidade = EntryPlaceHold(self.aba1, placeholder="Digite a cidade do cliente..")
