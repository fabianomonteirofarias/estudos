...
class Application(Funcs, Relatorios):
    ...
    def widgets_frame1(self):
        ...
        #moldura
        self.canvas_bt = Canvas(self.frame1, bd=0, bg="#1e2345",
        ...
        self.bl_buscar = tix.Balloon(self.frame1)
        self.bl_buscar.bind_widget(self.bt_buscar, balloonmsg=text_bl_buscar)

        # botão imagem novo
        # imagem

        self.btnovo = PhotoImage(data=base64.b64decode(self.bt_novo_base64))
        self.btnovo = self.btnovo.subsample(2,2)

        self.bt_novo = Button(self.frame1, bd=0, image=self.btnovo, command=self.add_cliente)
        self.bt_novo.place(width=self.bt_width, height=self.bt_height,
                           relx=0.6, rely=0.05)
