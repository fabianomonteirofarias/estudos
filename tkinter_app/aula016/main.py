# AULA 016 - Estilizando nosso Botões - Parte 2
...
class Application(Funcs, Relatorios):
    ...
    def widgets_frame1(self):
        ...
        # botão imagem novo
        # imagem
        self.imgNovo = PhotoImage(file="NOVO.png") #mudar parar uma imagem .gif
        self.imgNovo = self.imgNovo.subsample(2, 2)

        self.style = ttk.Style()
        self.style.configure("BW.TButton", relwidth=1, relheight=1,
                             foreground="gray", borderwidth=0,
